...
void AuctionHouseBot::Initialize()
{
    ...
    if (AHBSeller)
    {
        ...
        char lootQuery[] = "SELECT item FROM creature_loot_template UNION "
                           ...
                           "SELECT entry FROM item_template WHERE ItemLevel <= 435 AND VerfiedBuild <> 15595"; //TODO: Remove VerfiedBuild when cata items should be allowed. Keep WHERE ItemLevel <= 435 to exclude some OP items
