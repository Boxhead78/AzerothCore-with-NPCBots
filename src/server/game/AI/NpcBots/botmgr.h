...
class AC_GAME_API BotMgr
{
    public:
        ...
        static float GetBotsCheatFactor();
        static uint8 GetBotsCheatStartLevel();
        ...
        static uint32 GetDesiredWanderingBotsCountMin();
        static uint32 GetDesiredWanderingBotsCountMax();
