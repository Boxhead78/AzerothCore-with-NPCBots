...
enum BotGossips : uint32
{
    ...
    GOSSIP_SENDER_BOTGIVER_HIRE_RAID_GROUP,
    GOSSIP_SENDER_BOTGIVER_HIRE_RAID_GROUP_10,
    GOSSIP_SENDER_BOTGIVER_HIRE_RAID_GROUP_25,
    GOSSIP_SENDER_BOTGIVER_HIRE_RAID_GROUP_40,
    GOSSIP_SENDER_CLASS,
