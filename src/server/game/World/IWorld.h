...
enum WorldBoolConfigs
{
    ...
    CONFIG_WORLD_BOSS_RANDOM_SHOUTS,
...
enum Rates
{
    ...
    RATE_REPUTATION_GAIN_HEROIC_OR_RAID,
    ...
    RATE_CREATURE_ELITE_BOSS,
    RATE_CREATURE_ELITE_BOSS_HEROIC,
    RATE_CREATURE_ELITE_BOSS_RAID,
